    ...
    <div class="col-lg-12">
        <div class="col-md-3">
            <ul class="nav nav-pills nav-stacked navbar-custom-nav">
                ...
                $can_do = can_do(162);
                if (!empty($can_do)) { ?>
                    <li class="<?php echo ($load_setting == 'transactions') ? 'active' : ''; ?>">
                        <a href="<?= base_url() ?>admin/settings/transactions">
                            <i class="fa fa-fw fa-ticket"></i>
                            <?php echo lang('transactions_settings') ?>
                        </a>
                    </li>
                <?php }
                $can_do = can_do(127);
                ...
                $can_do = can_do(161);
                if (!empty($can_do)) { ?>
                    <li class="<?php echo ($load_setting == 'lead_form') ? 'active' : ''; ?>">
                        <a href="<?= base_url() ?>admin/leads/all_lead_form">
                            <i class="fa fa-fw fa-rocket"></i>
                            <?php echo lang('lead_form') ?>
                        </a>
                    </li>
                <?php }
                $can_do = can_do(129);
                ...
                $can_do = can_do(160);
                if (!empty($can_do)) { ?>
                    <li class="<?php echo ($load_setting == 'tags') ? 'active' : ''; ?>">
                        <a href="<?= base_url() ?>admin/settings/tags">
